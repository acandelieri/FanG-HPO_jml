...
if(.Platform$OS.type=="unix") {
  ...
  autogluonFairBO_results_folder = "/home/ac21041/Desktop/autogluon-0.3.1/FanG-HPO_AutogluonFairBO_runs/RF_HPO_LAWSCHOOLADMISSIONS_results"
  conda_python("autogluonFairBO")
} else {
  use_python(python="C:/Users/Public/anaconda3",required=T)
  autogluonFairBO_results_folder = "G:/Il mio Drive/AutogluonFairBO_results/RF_HPO_LAWSCHOOLADMISSIONS_results"
  conda_python("py3.8")
}
...
for( f in files ) {
  ...
  if( !dir.exists("results") )
    dir.create("results")
  saveRDS( object=run.info, file=paste0("results/results_LAWSCHOOLADMISSIONS_RF_file_",run,".RDS") )
  cat(" done!\n")
