...
if(.Platform$OS.type=="unix") {
  ...
  autogluonFairBO_results_folder = "/home/ac21041/Desktop/autogluon-0.3.1/FanG-HPO_AutogluonFairBO_runs/MLP_HPO_GERMANCREDIT_results"
  conda_python("autogluonFairBO")
} else {
  use_python(python="C:/Users/Public/anaconda3",required=T)
  autogluonFairBO_results_folder = "G:/Il mio Drive/AutogluonFairBO_results/MLP_HPO_GERMANCREDIT_results"
  conda_python("py3.8")
}
...
for( f in files ) {
  ...
  if( !dir.exists("results") )
    dir.create("results")
  saveRDS( object=run.info, file=paste0("results/results_GERMANCREDIT_MLP_file_",run,".RDS") )
  cat(" done!\n")
